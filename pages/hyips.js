                ...
                <div className="flex flex-col justify-between leading-normal">
                  ...
                  >
                    <a className="h-full py-6 lg:py-10 px-6 lg:px-6 block focus:outline-none ">
                      ...
                      {blog.mdesc && (
                        <p className="mt-3 text-lg opacity-60">{blog.mdesc}</p>
                      )}
                      ...
                      <button
                        ...
                        onClick={() => (window.location = 'https://rgeen.com')}
                      >
                        Go to Project
                      </button>
                    </a>
...
Hyips.getInitialProps = ({ query }) => {
  var globalData = getGlobalData();
  return singleCategory('hyip').then((data) => {
    if (data.error) {
