...
export default function Contact({ posts, globalData }) {
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('This function is still developing...');
  };
  return (
    <Layout>
      ...
      <main className=" w-full">
        <section className="bg-white dark:bg-gray-900 dark:bg-opacity-80 dark:bg-opacity-80">
